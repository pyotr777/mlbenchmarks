...
FILES=("CUDNN7/libcudnn7_7.0.5.15-1+cuda9.0_amd64.deb" "CUDNN7/libcudnn7-dev_7.0.5.15-1+cuda9.0_amd64.deb" "Chainer/run_cifar.sh" "HPCG/run_hpcg.sh" "Tensorflow-HP/run_tfhp.sh" "comb_profile.sh"  "parse_nvsmi.py")
