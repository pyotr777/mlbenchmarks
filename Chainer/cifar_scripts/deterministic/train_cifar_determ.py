...
def main():
    ...
    parser.add_argument('--export', action='store_true', help="Save model after initialisation")
    parser.add_argument('--load', action='store_true', help="Load initialised model")
    ...
    # save_file="VGG_optimizer.npz"
    # if args.export:
    #     chainer.serializers.save_npz(save_file,optimizer)
    #     print("Model saved to",save_file)

    # # Import model
    # if args.load:
    #     chainer.serializers.load_npz(save_file,optimizer)
    #     print("Loaded model from ", save_file)


    # save_file="VGG_optimizer.h5"
    # if args.export:
    #     chainer.serializers.save_hdf5(save_file,optimizer)
    #     print("Model saved to",save_file)

    # # Import model
    # if args.load:
    #     chainer.serializers.load_hdf5(save_file,optimizer)
    #     print("Loaded model from ", save_file)
    ...
    # save_file="VGG_train.npz"
    # if args.export:
    #     chainer.serializers.save_npz(save_file, trainer)
    #     print("Model saved to",save_file)

    if args.resume:
        # Resume from a snapshot
        chainer.serializers.load_npz(args.resume, trainer)
        print("Trainer loaded from",args.resume)
