    ...
    for batch in batchsizes:
        for lr in learnrates:
            ...
            if os.path.isfile(logfile):
                ...
                continue
            comm = "python train_gen_fixtime.py --early_stopping --batch_size {bs} -l {lr} --weight_decay 0.001 --model resnet50 --use_samples {sm} --time_limit {tl}".format(bs=batch, lr=lr, sm=samples, tl=time_limit)
            print(comm)
